    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="auth">
                    <a href="#auth">Auth</a>
                                ...
                                <a href="#auth-POSTapi-v1-auth-login">Inicio de sesión vía API</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="auth-POSTapi-v1-auth-logout">
                                <a href="#auth-POSTapi-v1-auth-logout">Cerrar sesión (Logout)</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="auth-POSTapi-v1-auth-me">
                                <a href="#auth-POSTapi-v1-auth-me">Obtener información del usuario autenticado</a>
                            </li>
                ...
                <li class="tocify-item level-1" data-unique="hotel">
                    <a href="#hotel">Hotel</a>
                                ...
                                <a href="#hotel-GETapi-v1-hotel--id-">Mostrar un hotel específico.</a>
                            </li>
...
<p>Documentación del API para la gestión de los hoteles</p>
<aside>
    <strong>Base URL</strong>: <code>http://localhost:8000</code>
</aside>
<pre><code>Esta documentación contiene la información necesaria para poder trabajar con el API

&lt;aside&gt;A medida que se vaya desplazando por el sitio descubrirá las apis disponible para su utilización asi como las respuestas&lt;/aside&gt;</code></pre>
...
<p>This API is not authenticated.</p>
    ...
    <p>Autenticación de un usuario en el API</p>
                                ...
                                <h2 id="auth-POSTapi-v1-auth-login">Inicio de sesión vía API</h2>

<p>
</p>

<p>Inicia la sesión de un usuario y devuelve un token de acceso.</p>
...
<span id="example-responses-POSTapi-v1-auth-login">
            <blockquote>
            <p>Example response (200, Inicio de sesión exitoso.):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;token&quot;: &quot;1|xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx&quot;
            ...
            <blockquote>
            <p>Example response (422, Credenciales inválidas.):</p>
        </blockquote>
                <pre>
...
<p>La contraseña del usuario. Example: <code>password</code></p>
                    ...
                    <h2 id="auth-POSTapi-v1-auth-logout">Cerrar sesión (Logout)</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Cierra la sesión del usuario actual revocando el token de acceso.</p>
...
<span id="example-responses-POSTapi-v1-auth-logout">
            <blockquote>
            <p>Example response (200, Cierre de sesión exitoso.):</p>
        </blockquote>
                <pre>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="auth-POSTapi-v1-auth-me">Obtener información del usuario autenticado</h2>
...
<span id="example-responses-POSTapi-v1-auth-me">
            <blockquote>
            <p>Example response (200, Información del usuario autenticado.):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;user&quot;: {
        ...
        &quot;email&quot;: &quot;jane.doe@example.com&quot;
            ...
            <blockquote>
            <p>Example response (422, Error de validación (ej. email ya registrado).):</p>
        </blockquote>
                <pre>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>El email único del usuario. Example: <code>jane.doe@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>La contraseña del usuario (mínimo 8 caracteres). Example: <code>newpassword</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Confirmación de la contraseña. Example: <code>newpassword</code></p>
        </div>
        </form>

                <h1 id="disponibilidad-del-hotel">Disponibilidad del Hotel</h1>

    <p>Gestión de la información de la disponibilidad del hotel</p>
...
<form id="form-GETapi-v1-availability" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-availability');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-availability"
                    onclick="cancelTryOut('GETapi-v1-availability');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>El número de página para la paginación. Example: <code>1</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>El número de elementos por página. Example: <code>15</code></p>
            </div>
                        <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>hotelId</code></b>&nbsp;&nbsp;
...
<form id="form-POSTapi-v1-availability" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-availability');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-availability"
                    onclick="cancelTryOut('POSTapi-v1-availability');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-availability--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-availability--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-availability--id-"
                    onclick="cancelTryOut('GETapi-v1-availability--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-PUTapi-v1-availability--id-" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PUTapi-v1-availability--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-availability--id-"
                    onclick="cancelTryOut('PUTapi-v1-availability--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-DELETEapi-v1-availability--id-" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('DELETEapi-v1-availability--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-availability--id-"
                    onclick="cancelTryOut('DELETEapi-v1-availability--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-catalogs-accommodations" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-catalogs-accommodations');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-catalogs-accommodations"
                    onclick="cancelTryOut('GETapi-v1-catalogs-accommodations');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-catalogs-rooms-types" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-catalogs-rooms-types');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-catalogs-rooms-types"
                    onclick="cancelTryOut('GETapi-v1-catalogs-rooms-types');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-GETapi-v1-catalogs-rules" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-catalogs-rules');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-catalogs-rules"
                    onclick="cancelTryOut('GETapi-v1-catalogs-rules');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>Example: <code>application/json</code></p>
    ...
    <p>Gestión de la información de un Hotel</p>
...
<form id="form-GETapi-v1-hotel" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-hotel');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-hotel"
                    onclick="cancelTryOut('GETapi-v1-hotel');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-POSTapi-v1-hotel" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-hotel');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-hotel"
                    onclick="cancelTryOut('POSTapi-v1-hotel');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>La dirección del hotel. Example: <code>CALLE 23 58-25</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Número de NIT del hotel. Example: <code>700562369-7</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>La cantidad de habitaciones disponibles. Mínimo: 1. Example: <code>50</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Identificador numérico asociado al hotel. Example: <code>167</code></p>
        </div>
        </form>

                    <h2 id="hotel-GETapi-v1-hotel--id-">Mostrar un hotel específico.</h2>
...
<form id="form-GETapi-v1-hotel--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-hotel--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-hotel--id-"
                    onclick="cancelTryOut('GETapi-v1-hotel--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>Modifica la información de un hotel. Valida la cantidad de habitaciones para evitar overbooking.</p>
...
<form id="form-PUTapi-v1-hotel--id-" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PUTapi-v1-hotel--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-hotel--id-"
                    onclick="cancelTryOut('PUTapi-v1-hotel--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<form id="form-DELETEapi-v1-hotel--id-" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('DELETEapi-v1-hotel--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-hotel--id-"
                    onclick="cancelTryOut('DELETEapi-v1-hotel--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
